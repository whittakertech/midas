    ...
    class Coin
      ...
      module Arithmetic
        ...
        def +(other)
          ...
          Coin.value(currency_minor + other.currency_minor, currency_code).freeze
        end
        ...
        def *(other)
          ...
          Coin.value(currency_minor * other, currency_code).freeze
        end
        ...
        # @return [Coin]
        def negate
          Coin.value(-currency_minor, currency_code).freeze
        end
        ...
        def divide(divisor, rounding_policy: WhittakerTech::Midas::DEFAULT_ROUNDING_POLICY)
          ...
          Coin.value(minor, currency_code).freeze
        end
        ...
        def ensure_same_currency!(other)
          raise TypeError unless other.is_a?(Coin)
